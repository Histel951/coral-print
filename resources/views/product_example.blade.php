...
<head>
    ...
    <link rel="stylesheet" href="css/style.css?v=d5138c6edd5eb05fd04d23e21bd8472b">
</head>
...
<body>
        ...
        <header class="header">
            <div class="header__gradient">
                <div class="header__top">
                    <a href="#" class="logo">
                        <img src="/images/logo/logo-horizontal.svg" alt="logo coral print">
                    </a>
                    <div class="contact">
                        <a href="tel:+74956637381" class="contact__phone phone">
                            <span class="phone__text hidden visible-md hidden-lg visible-xl">+7 495 663-73-81</span>
                            <img class="phone__icon hidden-md visible-lg hidden-xl" src="/images/icon/icon-phone.svg" alt="icon-phone">
                        </a>
                        <a href="mailto:info@coral-print.ru" class="contact__email email">
                            <span class="email__text hidden visible-md hidden-lg visible-xl">info@coral-print.ru</span>
                            <img class="email__icon hidden-md visible-lg hidden-xl" src="/images/icon/icon-email.svg" alt="icon-phone">
                        </a>
                    ...
                    <a href="#" class="link-cart">
                        <div class="link-cart__icon">
                            ...
                            <span class="link-cart__number">123</span>
                        </div>
            ...
            <div class="header__background">
                <div class="nav" data-id="nav">
                    <div class="nav__item" data-nav="item">
                        <a class="nav__link link_arrows" href="#" data-item="menu">Продукция</a>
                    ...
                    <div class="nav__item" data-nav="item">
                        <a class="nav__link link_arrows" href="#" data-item="menu">Услуги</a>
                        <div class="nav__dropdown">
                            <div class="nav__desc">
                                <a href="#" class="btn-back" data-btn="back"></a>
                                <ul>
                                    <li><a href="#">Баннеры 2</a></li>
                                    <li><a href="#">Бейджи</a></li>
                                    <li><a href="#">Билеты</a></li>
                                    <li><a href="#">Бирки</a></li>
                                    <li><a href="#">Благодарности</a></li>
                    ...
                    <div class="nav__item" data-nav="item">
                        <a class="nav__link link_arrows" href="#" data-item="menu">Конструктор макетов</a>
                        <div class="nav__dropdown">
                            <div class="nav__desc">
                                <a href="#" class="btn-back" data-btn="back"></a>
                                <ul>
                                    <li><a href="#">Баннеры 3</a></li>
                                    <li><a href="#">Бейджи</a></li>
                                    <li><a href="#">Билеты</a></li>
                                    <li><a href="#">Бирки</a></li>
                                    <li><a href="#">Благодарности</a></li>
                    ...
                    <div class="nav__item" data-nav="item">
                        <a class="nav__link link_arrows" href="#" data-item="menu">Фото работ</a>
                        <div class="nav__dropdown">
                            <div class="nav__desc">
                                <a href="#" class="btn-back" data-btn="back"></a>
                                <ul>
                                    <li><a href="#">Баннеры 4</a></li>
                                    <li><a href="#">Бейджи</a></li>
                                    <li><a href="#">Билеты</a></li>
                                    <li><a href="#">Бирки</a></li>
                                    <li><a href="#">Благодарности</a></li>
        ...
        <main>
            ...
            <section class="section-product">
                <div class="container">
                    <div class="need-labels" data-block="need-labels">
                        <a href="#" class="need-labels__link">
                            ...
                            <div class="need-labels__img">
                                <img src="/images/icon/icon-labels.svg" alt="icon-labels">
                            </div>
                        </a>
                    ...
                    <h1 class="page-title page-title_inner">Печать наклеек</h1>
                    <!-- Swiper -->
                        ...
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                ...
                                <a href="#" class="preview">
                                    <div class="preview__img">
                                        <img src="/images/icon/icon-preview.svg" alt="icon preview">
                                    </div>
                                    <span class="preview__name">Круглые наклейки с логотипом</span>
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Прямоугольные стикеры</span>
                                    <span class="preview__price">от 990 ₽</span>
                                </a>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Овальные стикеры</span>
                                    <span class="preview__price">от 350 ₽</span>
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Фигурные стикеры</span>
                                    <span class="preview__price">от 1680 ₽</span>
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Наборы стикеров</span>
                                    <span class="preview__price">от 350 ₽</span>
                                </a>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Наклейки на монтажной пленке</span>
                                    <span class="preview__price">от 1680 ₽</span>
                                </a>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Простые наклейки на бумаге</span>
                                    <span class="preview__price">от 350 ₽</span>
                                </a>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Наклейки на машину</span>
                                    <span class="preview__price">от 350 ₽</span>
                                </a>
                            </div>
                            ...
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Графика на пол</span>
                                    <span class="preview__price">от 350 ₽</span>
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Графика на стену</span>
                                    <span class="preview__price">от 350 ₽</span>
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Обратные стикеры</span>
                                    <span class="preview__price">от 350 ₽</span>
                                </a>
                            </div>
                            <div class="swiper-slide">
                                <a href="#" class="preview">
                                    ...
                                    <span class="preview__name">Обьемные стикеры</span>
                                    <span class="preview__price">от 350 ₽</span>
                                </a>
                            </div>
                        </div>
            ...
            <section>
                <div class="container">
                    <h2 class="block-title block-title_dark block-title_center">
                        Примеры работ
                    </h2>

                    <div class="gallery-tabs">
                        <ul class="gallery-tabs__list">
                            <li class="gallery-tabs__item featured-gallery active" data-tab="0"><i class="icon-cp-refresh"></i> Подборка</li>
                            <li class="gallery-tabs__item" data-tab="1">Наклейки любой формы</li>
                            <li class="gallery-tabs__item" data-tab="2">Стикерпаки</li>
                            <li class="gallery-tabs__item" data-tab="3">Графика и аппликации</li>
                            <li class="gallery-tabs__item" data-tab="4">Особенные наклейки</li>
                        </ul>
                    </div>

                    <div class="pure-g pure-g_plate" data-doc="3814" data-offset="0">
                        <div class="pure-u-1-2 pure-u-md-1-3 pure-u-lg-1-4">
                            <div class="examples" id="test">
                        ...
                        <div class="pure-u-1-2 pure-u-md-1-3 pure-u-lg-1-4">
                            <div class="examples">
                                <a class="examples__link" href="">
                                    <img src="https://www.nasa.gov/sites/default/files/styles/image_card_4x3_ratio/public/thumbnails/image/halloween_sun_2014_2k.jpg" alt="img examples" class="examples__img">
                                </a>
                            </div>
                        </div>
                        <div class="pure-u-1-2 pure-u-md-1-3 pure-u-lg-1-4">
                        ...
                        <div class="pure-u-1-2 pure-u-md-1-3 pure-u-lg-1-4">
                            <div class="examples circle">
                                <a class="examples__link" href="">
                                    <img src="/images/examples/2.jpg" alt="img examples" class="examples__img">
                                </a>
                            </div>
                        </div>
                        <div class="pure-u-1-2 pure-u-md-1-3 pure-u-lg-1-4 hidden-md visible-lg">
                            <div class="examples">
                                <a class="examples__link" href="">
                                    <img src="https://images.ctfassets.net/hrltx12pl8hq/6TOyJZTDnuutGpSMYcFlfZ/4dfab047c1d94bbefb0f9325c54e08a2/01-nature_668593321.jpg?fit=fill&w=480&h=270" alt="img examples" class="examples__img">
                                </a>
                            </div>
                        </div>
                        <div class="pure-u-1-2 pure-u-md-1-3 pure-u-lg-1-4 hidden visible-lg">
                            <div class="examples">
                                <a class="examples__link" href="">
                                    <img src="/images/examples/2.jpg" alt="img examples" class="examples__img">
                                </a>
                        ...
                        <div class="pure-u-1-2 pure-u-md-1-3 pure-u-lg-1-4 hidden visible-lg">
                            <div class="examples">
                                <a class="examples__link" href="">
                                    <img src="https://www.bhaktiphotos.com/wp-content/uploads/2018/04/Mahadev-Bhagwan-Photo-for-Devotee.jpg" alt="img examples" class="examples__img">
                                </a>
                            </div>
                        </div>
                        <div class="pure-u-1 pure-u-md-2-3 pure-u-lg-1-2">
                            <div class="examples video">
                                <a class="video__link" href="https://www.youtube.com/klb4w35rcas">
                                    <picture>
                                        <source srcset="https://i.ytimg.com/vi_webp/klb4w35rcas/mqdefault.webp" type="image/webp">
                                        <img class="video__media" src="https://i.ytimg.com/vi/klb4w35rcas/mqdefault.jpg" alt="video youtube" data-src="https://www.youtube.com/embed/klb4w35rcas">
                                    </picture>
                                </a>
                                <button class="video__button" aria-label="Запустить видео">
                                    <img src="/images/icon/icon-play.svg" alt="icon play">
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="pure-g pure-g_advantages">
                        <div class="pure-u-1 pure-u-md-1-2">
                            <div class="advantages">
                                <div class="advantages__media">
                                    <picture>
                                        <source srcset="/images/advantages/1-md.png" media="(min-width: 1280px)">
                                        <img src="/images/advantages/1-sm.png" alt="advantages images">
                                    </picture>
                                </div>
                                <div class="advantages__text">
                                    <h2>Уникальное качество печати</h2>
                                    <p>
                                        Лазерная печать на праймированой пленке. Отличная цветопередача. Пропечатка мельчайших
                                        деталей.
                                    </p>
                                </div>
                            </div>
                        ...
                        <div class="pure-u-1 pure-u-md-1-2">
                            <div class="advantages">
                                <div class="advantages__media">
                                    <picture>
                                        <source srcset="/images/advantages/2-md.png" media="(min-width: 1280px)">
                                        <img src="/images/advantages/2-sm.png" alt="advantages images">
                                    </picture>
                                </div>
                                <div class="advantages__text">
                                    <h2>Умеем белым по прозрачному</h2>
                                    <p>
                                        Супер кроющая УФ-печать на прозрачных и темных пленках. Всегда печатаем белый в четыре
                                        слоя.
                                    </p>
                                </div>
                            </div>
                ...
                <div class="container">
                    ...
                    <div class="reviews-stat">
                        <div class="reviews-stat__item">
                            <div class="reviews-stat__num">14 622</div>
                            <div class="reviews-stat__label">Отзыва от клиентов</div>
                        </div>
                        <div class="reviews-stat__item">
                            <div class="reviews-stat__num">4.98 / 5</div>
                    ...
                    <div class="reviews-list">
                            ...
                            <div class="p-review__top">
                                ...
                                <div class="p-review__top-content">
                                    <div class="p-review__head">
                                        ...
                                        <div class="p-review__title">Все четенько!</div>
                                    </div>
                                    <div class="p-review__info">
                                        <div class="p-review__author">Егор Клейчук</div>
                                        <div class="p-review__date">20 минут назад</div>
                                    </div>
                                </div>
                            </div>
                            <div class="p-review__text">
                                <p>Все понравилось: удобство заказа, скорость исполнения, поддержка менеджеров, качество — агонь!, доставка быстрая.</p>
                            </div>
                        </div>
                        <div class="p-review">
                            <div class="p-review__top">
                        ...
                        <div class="reviews-list__message">
                            <p>Оставьте свой отзыв ♡ и получите <span class="text-green">скидку 10%</span> на следующий заказ!</p>
                        </div>
                        <div class="reviews-list__btn">
                            <button class="btn btn_bg btn_lg" data-micromodal-trigger="add-review">Написать отзыв</button>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section>
                <div class="container">
                    <div class="bottom-text-wrap bottom-text-wrap_bordered">
                        <h2 class="title-seo">Зачем нужны наклейки?</h2>
                        <div class="bottom-text">
                            ...
                            <p>
                                Укрепление имиджа компании, создание фирменного стиля, увеличение количества клиентов – помочь с
                                решением любых ваших задач смогут специалисты типографии Coral Print простым материалом -
                                бумагой. Мы превращаем безликую бумажную продукцию в эффективный носитель рекламных изображений
                                и текстов.
                            </p>
                            <img src="/images/examples/2.jpg" alt="img">

                            <p>
                                Создание визиток и изготовление деловой или рекламной полиграфии методом шелкографии, цифровой,
                            ...
                            <p>
                                Красочные фото, рекламные тексты или яркие элементы фирменного стиля - мы перенесем на бумагу
                            ...
                            <p>
                                Покажите, как выглядят ваши варианты оформления визиток (или другие макеты) лично, в нашем офисе
                                или пришлите макеты по почте. Наши дизайнеры отлично понимают клиентов и используют эту
                                информацию и наброски оформления для разработки дизайна визитных карточек с нуля или оперативной
                                корректировки макетов.
                            </p>
                            <h4>Вы уже создали готовый макет, соответствующий минимальным необходимым требованиям?</h4>
                            <p>
                                Закажите необходимый тираж визиток или другой полиграфической продукции прямо из своего офиса.
                            ...
                            <p>
                                ...
                                изготовления заказа. К вашим услугам - уютные офисы, доброжелательные сотрудники, возможность
                            ...
                            <p>
                                Всего 15 минут ожидания - и вы сможете использовать ваши фирменные визитки, листовки, плакаты
                                или буклеты по их прямому назначению. Мы ждем вас по будням с 10-00 до 19-00 по адресу Москва,
                            ...
                            <p>
                                ...
                                высококачественных технологий печати изготовив деловую или рекламную полиграфию любого типа и
                                формата.
                            </p>
                            <p>
                ...
                <div class="container">
                    <div class="pay-and-deliv">
                        <div class="pure-g">
                            ...
                            Дляюридических и физических лиц.
                                    </div>
                                    <div class="p-d-item__link">
                                        <a href="#">Подробнее →</a>
                                    </div>
                                    <div class="p-d-item__text">
                                        <p>С юридическими лицами мы работаем по 100% предоплате и без НДС. Вы можете прислать нам реквизиты компании на <a href="#">электронный адрес</a> для выставления счета.</p>
                                        <p>Формы оплаты для физических лиц: банковские карты, Яндекс.Деньги и QIWI, интернет-банки, наличные, баланс мобильного и другие.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="pure-u-1 pure-u-md-1-2">
                            ...
                            Есть самовывоз в Москве*.
                                    ...
                                    <div class="p-d-item__text">
                                        <p>*В Москве в пределах МКАД, стоимость доставки распространяется на цифровые тиражи, кроме календарей, объявлений, брошюр и каталогов.</p>
                                        <p>Стоимость самовывоза из пунктов выдачи в Москве: м. Водный стадион — бесплатно, м. Белорусская — 90 ₽.</p>
                                        <p>По России доставляем с помощью сервиса Boxberry. Точную стоимость доставки, виды продукции подходящие под доставку уточняйте при расчете заказа у нашего менеджера.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="footer__search">
                    <a href="#" class="logo hidden visible-lg">
                        <picture>
                            <source srcset="/images/logo/logo-blue.svg" media="(min-width: 1280px)">
                            <img src="/images/logo/logo-vertical-blue-1.svg" alt="logo coral print">
                        </picture>
                    </a>
                    ...
                    <div class="btn-group">
                        <button class="btn btn_border" data-micromodal-trigger="back-call">
                            <i class="icon-cp-call-us hidden-lg visible-xl"></i>
                            Заказать звонок
                        </button>
                        <button class="btn btn_bg" data-micromodal-trigger="order-modal">
                    ...
                    <div class="accordion__item">
                        ...
                        <div class="accordion__content">
                            <ul class="product-list">
                                ...
                                <li><a href="#">Блокноты</a></li>
                                <li><a href="#">Брошюры</a></li>
                                <li><a href="#">Вырубка сложной формы</a></li>
                                <li><a href="#">Грамоты</a></li>
                                <li><a href="#">Сертификаты</a></li>
                                <li><a href="#">Благодарности</a></li>
                                <li><a href="#">Ценники</a></li>
                                ...
                                <li><a href="#">Купоны</a></li>
                                <li><a href="#">Тетради</a></li>
                                <li><a href="#">Печать на бэклите</a></li>
                                <li><a href="#">Холсты</a></li>
                                <li><a href="#">Цифровая печать</a></li>
                                <li><a href="#">Многостраничная печать</a></li>
                    ...
                    <div class="accordion__item">
                        ...
                        <div class="accordion__content">
                            <div class="contact-block">
                                <a href="tel:+74956637381" class="link link_phone">+7 495 663-73-81</a>
                                <a href="mailto:info@coral-print.ru" class="link link_email">info@coral-print.ru</a>
                                <ul class="social">
                            ...
                            <div class="contact-block">
                                ...
                                <ul class="address">
                                    <li class="address__item">
                                        <p>ул. Выборгская, 22, стр 3</p>
                                        <p>
                                            <img src="/images/icon/icon-metro.svg" alt="icon metro">
                                            Водный стадион
                                        </p>
                                    </li>
                                    <li class="address__item">
                                        <p>Ленинградский проспект, д. 2</p>
                                        <p>
                                            <img src="/images/icon/icon-metro.svg" alt="icon metro">
                                            Белорусская
                                        </p>
                            ...
                            <div class="contact-block">
                                <h5>Реквизиты</h5>
                                <p>
                                    ИНН: 7714755828 Московский банк Сбербанка России ОАО БИК: 044525225 КПП: 771401001
                ...
                <div class="footer__copy">
                    ...
                    <a class="dda" href="https://ddaproduction.com/">
                        <img class="dda__logo" src="/images/logo/logo-DDA.svg" alt="Сделано в DDA Production">
    ...
    <button class="go-top" data-id="btn-scroll" type="button">
        <svg width="22" height="23" viewBox="0 0 22 23" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd" d="M11 0.75L22 11.957L20.5345 13.3955L12.0267 4.72752V22.7503H9.97324V4.72753L1.46549 13.3955L0 11.957L11 0.75Z" />
        </svg>
    </button>
                ...
                <div class="modal__content">
                    <div class="back-call">
                        ...
                        <form id="back-call-from" action="#" method="post">
                            ...
                            <button class="btn btn_bg">Заказать</button>
                        </form>
                ...
                <div class="modal__content">
                    ...
                    <form class="modal-form form-validation" action="#" id="modal-order-form">
                        <div class="pure-g">
                            <div class="pure-u-1 pure-u-md-1-2">
                                <div class="modal-form__field validation-group">
                                    <input type="text" required class="input input_wide" name="name" placeholder="Ваше имя" data-pristine-required-message="Это поле обязательно для заполнения">
                                </div>
                                <div class="modal-form__field validation-group">
                                    <input type="email" required class="input input_wide" name="email" placeholder="E-mail" data-pristine-required-message="Это поле обязательно для заполнения" data-pristine-email-message="Неправильный формат email">
                                </div>
                                <div class="modal-form__field validation-group">
                                    <textarea type="text" required class="input input_area input_wide" cols="1" rows="6" name="message" placeholder="Что вы хотите заказать?" data-pristine-required-message="Это поле обязательно для заполнения"></textarea>
                                </div>
                            </div>
                            <div class="pure-u-1 pure-u-md-1-2">
                                <div class="modal-form__title">Файлы</div>
                                <div class="modal-form__field">
                                    <div class="files-upload files-upload_vertical">
                                        <input class="files-upload__inp" type="text" name="privileges-photo" id="privileges-photo">
                                        <div class="files-upload__dropzone-holder">
                                            <div class="files-upload__accepted files-upload__accepted_mob">Если вам нужно отправить нам макет. Максимальный объем одного файла — 100 МВ. Допустимые форматы
                                                файлов: jpg, png, tif, svg, pdf, ai, psd
                                            </div>
                                            <div class="dropzone files-upload__dropzone">
                                                <span class="hidden-md">Загрузить файлы</span>
                                            </div>
                                            <div class="files-upload__accepted files-upload__accepted_dt">Допустимые форматы файлов: jpg, png, tif, svg, pdf, ai, psd</div>
                                        </div>
                        ...
                        <div class="modal-form__bottom-agree">
                            <div class="validation-group">
                                <div class="custom-checkbox custom-checkbox_center-align">
                                    <input class="custom-checkbox__input" required type="checkbox" name="agree-personal" value="" id="agree-personal" data-pristine-required-message=" ">
                        ...
                        <div class="modal__footer">
                            <button class="btn btn_bg validation-submit" disabled>Отправить заявку</button>
                        </div>
                    </form>
                </div>
                <div class="modal__close" data-micromodal-close><i class="icon-close"></i></div>
            ...
            <div class="modal__holder modal__holder_order" role="dialog" aria-modal="true">
                <div class="modal__content">
                    ...
                    <form class="modal-form form-validation" action="/send_review" method="post" id="review-form">
                        <input hidden name="product_category" value="7">
                        <div class="pure-g">
                            <div class="pure-u-1 pure-u-md-1-2">
                                <div class="modal-form__field validation-group">
                                    <input type="text" required class="input input_wide" name="name" placeholder="Ваше имя" data-pristine-required-message="Это поле обязательно для заполнения">
                            ...
                            <div class="pure-u-1 pure-u-md-1-2">
                                <div class="modal-form__field validation-group">
                                    <div class="avatar-upload">
                                        <input class="avatar-upload__inp" required type="text" name="file_id" id="avatar" data-pristine-required-message="Это поле обязательно для заполнения">
                                        ...
                                        <div class="avatar-upload__accepted">Допустимые форматы файлов: JPG, GIF или PNG. 150✗150 px, максимум 1 MB.</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="modal-form__field validation-group">
                            <input type="text" required class="input input_wide" name="title" placeholder="Ваше общее впечатление о заказе" data-pristine-required-message="Это поле обязательно для заполнения">
                        </div>

                        <div class="modal-form__field validation-group">
                            <textarea type="text" required class="input input_area input_wide" cols="1" rows="6" id="comment" name="comment" placeholder="Ваш отзыв (до 1000 символов)" data-pristine-required-message="Это поле обязательно для заполнения"></textarea>
                        </div>
    ...
    <script src="js/scripts.js?v=d5138c6edd5eb05fd04d23e21bd8472b"></script>
</body>
