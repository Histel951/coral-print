...
class ClosureTable extends Eloquent
{
    ...
    private function selectRowsToInsert($ancestorId, $descendantId)
    {
        ...
        $rows = $this->getConnection()->select($select, [$descendantId, $ancestorId, $descendantId, $descendantId]);
    ...
    public function moveNodeTo($ancestorId = null)
    {
        ...
        $this->getConnection()->statement($query, [$ancestorId, $this->descendant]);
    }
    ...
    protected function unbindRelationships()
    {
        ...
        $this->getConnection()->delete($query, [$this->descendant, $this->descendant, $this->descendant]);
    }
